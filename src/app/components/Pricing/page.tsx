...
export default function pricingMenu(){
    ...
    return(
        <div className="font-inter">
            ...
            <div className="flex mt-[7.5rem] gap-10  ">
                <section className="flex max-sm:grid max-sm:grid-cols-1  max-sm:gap-4 max-sm:pr-[5rem]">
                    <Card className="w-[300px] max-sm:w-full shadow-lg ml-[10rem] max-sm:ml-[4rem] min-h-[400px] bg-white border-[#234969] flex flex-col p-6">
